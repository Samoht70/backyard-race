...
return [
    ...
    'refusal' => [
        ...
        'racing' => 'L’événement est « :status » : une inscription n’est plus une ligne de formulaire, c’est un coureur sur le terrain.',
    ],
    'section' => [
        'runner' => 'Le coureur',
    ...
    'manage' => [
        ...
        'select_title' => 'Aucune fiche ouverte',
        'select_description' => 'Choisis une inscription dans la liste : sa fiche s’ouvre ici, sans quitter la page.',
        ...
        'deleted' => 'L’inscription de :name et son compte sont supprimés.',
    ],
    'transition' => [
        'confirm' => 'Confirmer',
    ...
    'delete' => [
        ...
        'confirm_description' => 'L’inscription, le compte de :name et ses sessions sont effacés. Rien ne se récupère : le dossard laisse un trou et le coureur reprend l’inscription depuis le début.',
        'submit' => 'Supprimer définitivement',
        'keep' => 'Ne rien supprimer',
