...
- [ ] **T1** — Migration et modèle `Event`, énumération de statut castée `2 pts`
- [ ] **T2** — Factory et seeder de l'événement d'anniversaire `1 pt`
- [ ] **T3** — Service de transition de statut avec ses garde-fous `2 pts`
- [ ] **T4** — Contrôleur, Form Requests et Policy pour la configuration `2 pts`
- [ ] **T5** — Écran de configuration côté gérant et page publique d'information `2 pts`
- [ ] **T6** — Tests des transitions autorisées et refusées `2 pts`
